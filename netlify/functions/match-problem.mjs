...
const VIDEOS = [
  ...
  { id: "YDvUy5VYm9E", title: "Chapter 22 — Distance Formula", topics: "finding the distance between two points on the coordinate plane using d = √((x₂−x₁)² + (y₂−y₁)²). Plug in the coordinates of two points like (−3, −1) and (5, 5), compute the squared differences, sum, then square root. Comes from the Pythagorean theorem applied to the horizontal and vertical gaps. Like 'find the distance between (2, 3) and (7, 15)'. NOT about midpoint, NOT about slope" },
  { id: "pzDfd8NXRXk", title: "Chapter 22 — Midpoint Formula", topics: "finding the midpoint of the segment between two points using M = ((x₁+x₂)/2, (y₁+y₂)/2). Average the x-coordinates, average the y-coordinates — those averages are the midpoint's (x, y). Like 'find the midpoint of (−3, −1) and (5, 5)' giving (1, 2). NOT about distance, NOT about slope" },
  { id: "u_39J-syjB0", title: "Chapter 23 — Graphing Circles & Writing Equations in Standard Form", topics: "circles in standard form (x−h)² + (y−k)² = r², where (h, k) is the center and r is the radius. Two directions: (1) given an equation like (x−3)² + (y+2)² = 25, identify center (3, −2) and radius 5, then graph it. (2) given a center and a radius (or a center and a point on the circle), write the standard form equation. Watch the signs — (x+2)² means h = −2. Conic sections introduction. NOT about ellipses, parabolas, or hyperbolas" },
];
